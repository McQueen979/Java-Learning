...
*/
    ...
    public void rePaintView() {
        ...
        for (int i = 0; i < datas.length; i++) {
            for (int j = 0; j < datas[i].length; j++) {
                JLabel imageLabel = new JLabel(new ImageIcon("Basic\\images\\" + datas[i][j] + ".png"));
    ...
    public void paintView() {
        //标题图片JLabel
        JLabel titleLabel = new JLabel(new ImageIcon("Basic\\images\\title.png"));
        ...
        //参照图
        JLabel canZhaoTuLabel = new JLabel(new ImageIcon("Basic\\images\\canZhaoTu.png"));
        canZhaoTuLabel.setBounds(574, 114, 122, 121);
        this.add(canZhaoTuLabel);
        //上按钮
        shangButton = new JButton(new ImageIcon("Basic\\images\\shang.png"));
        shangButton.setBounds(732, 265, 57, 57);
        this.add(shangButton);
        //左按钮
        zuoButton = new JButton(new ImageIcon("Basic\\images\\zuo.png"));
        zuoButton.setBounds(650, 347, 57, 57);
        this.add(zuoButton);
        //下按钮
        xiaButton = new JButton(new ImageIcon("Basic\\images\\xia.png"));
        xiaButton.setBounds(732, 347, 57, 57);
        this.add(xiaButton);
        //右按钮
        youButton = new JButton(new ImageIcon("Basic\\images\\you.png"));
        youButton.setBounds(813, 347, 57, 57);
        this.add(youButton);
        //求助按钮
        qiuZhuButton = new JButton(new ImageIcon("Basic\\images\\qiuzhu.png"));
        qiuZhuButton.setBounds(626, 444, 108, 45);
        this.add(qiuZhuButton);
        //重置按钮
        chongZhiButton = new JButton(new ImageIcon("Basic\\images\\chongzhi.png"));
        chongZhiButton.setBounds(786, 444, 108, 45);
        this.add(chongZhiButton);
        //背景图
        JLabel backgroundLabel = new JLabel(new ImageIcon("Basic\\images\\background.png"));
